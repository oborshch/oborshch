...
- [В iPhone 12 нашли функцию обратной зарядки. Она пока не работает](https://coderlog.top/news.php?id=38)
- [Apple создают свой поисковик](https://coderlog.top/news.php?id=37)
- [Facebook объявила живого пользователя мёртвым](https://coderlog.top/news.php?id=36)
- [Код youtube-dl распространяют на альтернативных платформах, в виде картинок и с помощью уязвимости GitHub](https://coderlog.top/news.php?id=35)
- [X.Org Server предложили признать заброшенным проектом](https://coderlog.top/news.php?id=34)
<!-- BLOG-POST-LIST:END -->
</br></br>
